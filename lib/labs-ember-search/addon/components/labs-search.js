...
import { classNames } from '@ember-decorators/component'; // eslint-disable-line
import { task, timeout } from 'ember-concurrency';
import { argument } from '@ember-decorators/argument'; // eslint-disable-line
import { Action } from '@ember-decorators/argument/types'; // eslint-disable-line
import { type } from '@ember-decorators/argument/type'; // eslint-disable-line
...
class LabsSearchComponent extends Component {
  constructor() {
    super();
    const { host = 'https://search-api.planninglabs.nyc', route = 'search' } =
